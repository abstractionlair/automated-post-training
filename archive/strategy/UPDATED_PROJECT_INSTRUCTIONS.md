...
1. **ALWAYS check first**: `/Users/user/MaximalCAI/PERSISTENT_STATE.md`
...
2. **Review workflow status**: Check `/Users/user/MaximalCAI/reviews/` directory
...
3. **Implementation status**: Check `/Users/user/MaximalCAI/scripts/`
...
- **RunPod SSH**: `ssh -T <redacted-pod-id>@ssh.runpod.io -i ~/.ssh/id_ed25519`
...
```bash
# SSH to RunPod
ssh -T <redacted-pod-id>@ssh.runpod.io -i ~/.ssh/id_ed25519

# Deploy code to RunPod
scp -r scripts/* <redacted-pod-id>@ssh.runpod.io:/workspace/cai-constitution-bootstrap/scripts/

# Run baseline assessment
ssh -T <redacted-pod-id>@ssh.runpod.io "cd /workspace/cai-constitution-bootstrap && python scripts/baseline_assessment.py"

# Run Stage 1
ssh -T <redacted-pod-id>@ssh.runpod.io "cd /workspace/cai-constitution-bootstrap && python scripts/orchestrate_stage1.py"

# Check pod status
ssh -T <redacted-pod-id>@ssh.runpod.io "nvidia-smi"
```
