...
# Configuration
POD_SSH_PROXY="<redacted-pod-id>@ssh.runpod.io"  # Stable proxy for file transfers
POD_SSH_DIRECT="root@<redacted-pod-ip>"  # Direct for commands (port may change)
...
# Project mappings
LOCAL_PROJECT="-Users-user-MaximalCAI"
