...
│   ├── projects/
│   │   ├── -Users-user-MaximalCAI/         # Local project sessions
...
1. **Stable Proxy** (`<redacted-pod-id>@ssh.runpod.io`)
...
2. **Direct SSH** (`root@<redacted-pod-ip> -p 48550`)
...
- Local: `/Users/user/MaximalCAI/` → `-Users-user-MaximalCAI`
...
ssh -T root@<redacted-pod-ip> -p $RUNPOD_PORT -i ~/.ssh/id_ed25519
```
...
**RunPod:**
- Stable SSH proxy: Always `<redacted-pod-id>@ssh.runpod.io`
