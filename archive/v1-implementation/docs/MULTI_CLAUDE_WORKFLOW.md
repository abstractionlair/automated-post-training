...
**User** (completed):
- ✅ SSH'd to pod: `ssh root@<redacted-pod-ip> -p 22069 -i ~/.ssh/id_ed25519`
...
**User** (planned):
- Download sample data: `scp -P 22069 -i ~/.ssh/id_ed25519 root@<redacted-pod-ip>:/workspace/MaximalCAI/artifacts/sample_*.jsonl ./`
